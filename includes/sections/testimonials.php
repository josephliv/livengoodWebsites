...
<div class="testimonial-container">
    <!-- a -->
    <div class="testimonial neon-border" data-aos="fade-right" >
    ...
    <!-- c -->
    <div class="testimonial neon-border" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-delay="200">
    ...
    <!-- d -->
    <div class="testimonial neon-border" data-aos="fade-left" data-aos-delay="200">
    ...
    <!-- e -->
    <div class="testimonial neon-border" data-aos="fade-left" data-aos-delay="300">
    ...
    <!-- f -->
    <div class="testimonial neon-border" data-aos="fade-left" >
    ...
    <!-- g -->
    <div class="testimonial neon-border" data-aos="fade-center" >
    ...
    <!-- i -->
    <div class="testimonial neon-border" data-aos="zoom-in" data-aos-easing="ease-in-out" data-aos-delay="1200">
    ...
    <!-- j -->
    <div class="testimonial neon-border" data-aos="fade-right" data-aos-easing="ease-in-out" data-aos-delay="900">
    ...
    <!-- k -->
    <div class="testimonial neon-border" data-aos="fade-left" data-aos-easing="ease-in-out" data-aos-delay="1200">
    ...
    <!-- l -->
    <div class="testimonial neon-border" data-aos="zoom-in" data-aos-duration="800" data-aos-easing="ease-in-out" data-aos-delay="200">
    ...
    <!-- m -->
    <div class="testimonial neon-border" data-aos="fade-down" data-aos-easing="ease-in-out" data-aos-delay="500">
    ...
    <!-- n -->
    <div class="testimonial neon-border" data-aos="zoom-in" data-aos-easing="ease-in-out" data-aos-delay="200">
    ...
    <!-- o -->
    <div class="testimonial neon-border">
    ...
    <!-- p -->
    <div class="testimonial neon-border" data-aos="fade-down" data-aos-easing="ease-in-out" >
    ...
    <!-- q -->
    <div class="testimonial neon-border" data-aos="fade-down" data-aos-easing="ease-in-out" data-aos-delay="1000">
