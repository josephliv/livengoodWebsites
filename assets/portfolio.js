...
var cohenClose = document.getElementById("cohen-close");
 ...
 cohenClose.onclick = function() { 
  cohenModal.style.display = "none";
}
 
//************************************ */
//  For Dart defense website 
//************************************ */
var dartModal = document.getElementById("dart-modal");
// Get the element that closes the modal
 var dartClose = document.getElementById("dart-close");
 // Get the image and insert it inside the modal - use its "alt" text as a caption
...
//************************************ */
var despeModal = document.getElementById("despe-modal");
// Get the element that closes the modal
 var despeClose = document.getElementById("despe-close");
 // Get the image and insert it inside the modal - use its "alt" text as a caption
 ...
 despeClose.onclick = function() { 
   despeModal.style.display = "none";
 }

/************************************ */
//  live young die rich website 
//************************************ */
var alrModal = document.getElementById("alr-modal");
// Get the element that closes the modal
 var alrClose = document.getElementById("alr-close");
 // Get the image and insert it inside the modal - use its "alt" text as a caption
...
//  the pcp usa website 
//************************************ */
var pcpModal = document.getElementById("pcp-modal");
// Get the element that closes the modal
 var pcpClose = document.getElementById("pcp-close");
 // Get the image and insert it inside the modal - use its "alt" text as a caption
 ...
 pcpClose.onclick = function() { 
   pcpModal.style.display = "none";
 }
 
   /************************************ */
//  the butler county pcp usa website 
//************************************ */
var butlerModal = document.getElementById("butler-modal");
// Get the element that closes the modal
 var butlerClose = document.getElementById("butler-close");
 // Get the image and insert it inside the modal - use its "alt" text as a caption
